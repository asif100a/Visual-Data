...
const IndividualWidget = ({ student, handleUpdateViewModal, handleDeleteStudent }) => {
    ...
    return (
        <div className='relative h-fit w-auto group'>
            ...
            <div className='shadow-widget hover:cursor-pointer w-fit h-fit px-3 md:px-6 pb-3 md:pb-6 pt-2 md:pt-3 rounded-xl'>
                <div className='mb-3'>
                    <h3 className='text-sm md:text-base font-semibold'>Student Progress</h3>
                </div>
                ...
                {/* Roll and Marks */}
                <div className='text-xs md:text-sm font-bold flex justify-center gap-3 mt-3'>
                ...
                <div className='flex gap-3 items-center mt-3'>
                    <div className='border rounded-full w-fit h-fit p-2 text-[#7bc095] bg-[#82ca9d33]'>
                        <FiUser className='text-base md:text-2xl' />
                    </div>
                    <div className='flex flex-col'>
                        <span className='text-[8px] md:text-xs font-bold'>Student</span>
